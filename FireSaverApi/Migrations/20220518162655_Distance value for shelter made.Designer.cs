...
namespace FireSaverApi.Migrations
{
    ...
    [Migration("20220518162655_Distance value for shelter made")]
    partial class Distancevalueforsheltermade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FireSaverApi.DataContext.Compartment", b =>
                {
                    ...
                    b.Property<string>("CompartmentPointsDataPublicId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FireSaverApi.DataContext.ScaleModel", b =>
                {
                    ...
                    b.Property<double>("ImageXToRealXProjectCoef")
                        .HasColumnType("float");

                    b.Property<double>("ImageXToRealYProjectCoef")
                        .HasColumnType("float");

                    b.Property<double>("ImageYToRealXProjectCoef")
                        .HasColumnType("float");

                    b.Property<double>("ImageYToRealYProjectCoef")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("FireSaverApi.DataContext.Shelter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ShelterPosition")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FireSaverApi.DataContext.User", b =>
                {
                    ...
                    b.HasOne("FireSaverApi.DataContext.Shelter", "Shelter")
                        .WithMany("Users")
